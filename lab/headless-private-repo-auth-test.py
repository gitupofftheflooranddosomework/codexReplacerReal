...
def main():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        with mock.patch.dict(os.environ, clean, clear=True), mock.patch.object(mod.subprocess, "run", return_value=result) as run:
            env = mod.git_environment(job_dir, "https://github.com/dotmoosehosting/DotMoose.git")
        ...
        assert env["GIT_CONFIG_VALUE_1"].endswith(expected)

        try:
            mod.git_environment(job_dir, "https://secret@github.com/dotmoosehosting/DotMoose.git")
        ...
        with mock.patch.dict(os.environ, {}, clear=True):
            env = mod.git_environment(job_dir, "https://example.invalid/public/repo.git")
